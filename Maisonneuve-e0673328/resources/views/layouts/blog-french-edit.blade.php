<div class="form-body-cart">
    <div>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="titre" name="titre" class="form-control" value="{{ $blog->titre }}">
            @if ($errors->has('titre'))
        ...
        <div class="mb-3">
            ...
            <textarea type="text" id="contenu" name="contenu" class="form-control">{{ $blog->contenu }}</textarea>
